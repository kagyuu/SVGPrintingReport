...
do
  ...
  gs -o $A4L_FILE -sDEVICE=pdfwrite -sPAPERSIZE=a4 -g5950x8420 -c "<</PageOffset[0 25]>> setpagedevice" -f ./a3/$A3_FILE
  gs -o $A4R_FILE -sDEVICE=pdfwrite -sPAPERSIZE=a4 -g5950x8420 -c "<</PageOffset[-525 25]>> setpagedevice" -f ./a3/$A3_FILE
done
